...
obfuscateSrc().then(() => {
    ...
    builder.build({
        config: {
            ...
            files: ["src/**/*", "package.json", "LICENSE.md", "main.js", "src/resources/html/loading.html", "preload.js"],
            ...
            win: {
                icon: "./src/resources/img/NakamaStreamIcon.ico",
                target: [{
                    target: "nsis",
                    arch: ["x64", "ia32"]
                }]
            ...
            mac: {
                icon: "./src/resources/img/NakamaStreamIcon.icns",
            ...
            linux: {
                icon: "./src/resources/img/NakamaStreamIcon.png",
                target: [
                    {
                    target: "AppImage",
                    arch: ["x64"]
